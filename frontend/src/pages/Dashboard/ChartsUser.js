...
const getOptions = (theme) => ({
    ...
    plugins: {
        ...
        datalabels: {
            ...
            textStrokeColor: theme.palette.mode === 'dark' ? "#333333" : "#000",
            textStrokeWidth: 2,
            font: {
                size: 20,
                weight: "bold"
    ...
    scales: {
        x: {
            ...
            grid: {
                color: theme.palette.mode === 'dark' ? "#FFFFFF" : "#e0e0e0",
            }
        },
        y: {
            ticks: {
...
export const ChatsUser = () => {
    ...
    return (
        <>
            ...
            <Bar options={getOptions(theme)} data={dataCharts} style={{ maxWidth: '100%', maxHeight: '280px', }} />
        </>
    );
}