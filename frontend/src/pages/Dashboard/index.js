...
const useStyles = makeStyles((theme) => ({
  ...
  filterButton: {
    backgroundColor: theme.palette.mode === 'dark' ? "#1BAB8C" : undefined,
    color: theme.palette.mode === 'dark' ? "#FFF" : undefined,
    "&:hover": {
      backgroundColor: theme.palette.mode === 'dark' ? "#168b6f" : undefined,
    },
  },
  chartContainer: {
    "& .recharts-text": {
    ...
    "& .recharts-cartesian-grid-horizontal line": {
      stroke: theme.palette.mode === 'dark' ? "#FFFFFF" : "#e0e0e0",
    },
    "& .recharts-cartesian-grid-vertical line": {
      stroke: theme.palette.mode === 'dark' ? "#FFFFFF" : "#e0e0e0",
    },
    "& .recharts-legend-item-text": {
      color: theme.palette.mode === 'dark' ? "#FFFFFF !important" : "#333333 !important",
    },
    "& .recharts-tooltip-wrapper": {
      "& .recharts-default-tooltip": {
        backgroundColor: theme.palette.mode === 'dark' ? "#333333" : "#FFFFFF",
        border: theme.palette.mode === 'dark' ? "1px solid #FFFFFF" : "1px solid #333333",
        ...
        <>
          <Grid item xs={12} sm={6} md={4}>
            <TextField
              ...
              className={`${classes.fullWidth} ${classes.dateFilter}`}
              InputLabelProps={{
                shrink: true,
              }}
            />
